//
//  DetailsEquipmentOryxViewController.swift
//  TheLossesOfRussia
//
...
class DetailsEquipmentOryxViewController: UIViewController {
    
    private var tableView: UITableView!
    
    var equipmentOryx: EquipmentOryx?
    
    init(equipmentOryx: EquipmentOryx) {
...
extension DetailsEquipmentOryxViewController: UITableViewDataSource, UITableViewDelegate {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return PropertyMapper.properties(for: equipmentOryx).count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let property = PropertyMapper.properties(for: equipmentOryx)[indexPath.row]
